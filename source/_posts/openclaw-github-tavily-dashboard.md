...
## 坑三：可视化面板，skill 检测报了可疑，自己去重找了一个

这是今天花时间最多的一个环节。

ClawHub 上搜到一个 `openclaw-mission-control`，Stars 数量很高，功能描述也很诱人——实时会话、cron 管理，成本追踪、任务看板……结果 ClawHub 官方安全标记了 **SUSPICIOUS**。

跑了一遍 vet，报告打出来是 HIGH 风险。但回头仔细看代码——其实逻辑本身没有太大问题，只是 ClawHub 的检测系统比较保守，误报了。

纠结了一阵，最后还是决定谨慎起见，自己去 ClawHub 重找了一个：https://github.com/TianyiDataScience/openclaw-control-center
...
| Mission Control | ⚠️ 放弃 | 安全标记 SUSPICIOUS，有点误报，但谨慎起见还是换了 |
